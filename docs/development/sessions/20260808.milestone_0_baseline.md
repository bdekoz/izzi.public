...
| `M0-CONSUMER-001` | Cartofreako and alpha60-results smoke consumers are documented but not implemented as pinned offline jobs | futures plan and [`20260806.audit.md`](20260806.audit.md) | NOT-STARTED |
