...
3. **Stale numbers** — `docs/development/sessions/20260808.milestone_0_baseline.md` cites
   "106 examples / 100 visual" (the generation baseline now carries 115
   examples in candidates); `20260814.movement.md` cites
...
- Documentation fix list applied: root `README.md`/`index.md` now link the
  ...
  (`movement.md` 43/43, `20260808.milestone_0_baseline.md` note on 115 examples);
