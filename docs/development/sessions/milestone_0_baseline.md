...
| `M0-CONSUMER-001` | Cartofreako and alpha60-results smoke consumers are documented but not implemented as pinned offline jobs | futures plan and [`explore_futures.20260806.audit.md`](explore_futures.20260806.audit.md) | NOT-STARTED |
