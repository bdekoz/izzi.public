...
| guilloche | `examples/guilloche-plates.cc` (composition kinds × render profiles); `examples/guilloche-capability-plates.cc` (9 categories × 3 parameter variations) | `izzi::guilloche::composition_spec`, `plate_spec`, `scene_spec`, `render_profile`, `pattern_class`, `pattern_family` | ![Guilloche data-orbit experimental plate](generative_patterns/images/guilloche.png) |
